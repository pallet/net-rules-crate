...
$EDITOR resources/pallet_crate/net_rules_crate/meta.edn
$EDITOR doc-src/USAGE.md
git add resources/pallet_crate/net_rules_crate/meta.edn doc-src/USAGE.md doc-src/FOOTER.md \
